...
// Fetch department_id and category as dropdown options
public function getDropdownOptions()
{
    try {
        $roles = Role::select('role_id', 'category')->distinct()->get();
        return response()->json($roles, Response::HTTP_OK);
    } catch (\Exception $e) {
        return response()->json(['error' => 'Failed to fetch dropdown options'], Response::HTTP_INTERNAL_SERVER_ERROR);
    }
}
