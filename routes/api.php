...
Route::middleware(['auth:sanctum', 'token.expiration'])->group(function () {
    ...
    Route::prefix('sustainability-homes')->group(function () {
        ...
        Route::post('/', [SustainabilityHomeController::class, 'store']);
        Route::put('/{sustainability_home_id}', [SustainabilityHomeController::class, 'update']);
    ...
    Route::prefix('about')->group(function () {
        ...
        Route::get('/{about_id}', [AboutController::class, 'show']);
        Route::post('/{about_id}/update', [AboutController::class, 'update']);
        Route::delete('/{about_id}', [AboutController::class, 'destroy']);
        Route::get('/count', [AboutController::class, 'countAbout']);
        Route::get('/dropdown', [AboutController::class, 'getDropdownOptions']);
    });
    ...
    Route::prefix('mcl-home')->group(function () {
        ...
        Route::get('/sliders', [MclHomeController::class, 'mclhmeSlider'])->name('mcl-home.sliders');
        Route::get('/{mcl_home_id}', [MclHomeController::class, 'show'])->name('mcl-home.show');
        Route::post('/', [MclHomeController::class, 'store'])->name('mcl-home.store');
        Route::post('/{mcl_home_id}', [MclHomeController::class, 'update'])->name('mcl-home.update');
        Route::delete('/{mcl_home_id}', [MclHomeController::class, 'destroy'])->name('mcl-home.destroy');
    });
    ...
    Route::prefix('diversity-home')->group(function () {
        ...
        Route::get('/{dhome_id}', [DiversityHomeController::class, 'show']);
        Route::post('/{dhome_id}/update', [DiversityHomeController::class, 'update']);
        Route::delete('/{dhome_id}', [DiversityHomeController::class, 'destroy']);
        Route::get('/count', [DiversityHomeController::class, 'countDiversityHome']);
    ...
    Route::prefix('diversity')->group(function () {
        ...
        Route::get('/{diversity_id}', [DiversityInclusionController::class, 'show']);
        Route::post('/', [DiversityInclusionController::class, 'store']);
        Route::post('/{diversity_id}', [DiversityInclusionController::class, 'update']);
    ...
    Route::prefix('subcategories')->group(function () {
        ...
        Route::post('/', [SubcategoryWeDoController::class, 'store']);
        Route::put('/{subcategoryWeDo}', [SubcategoryWeDoController::class, 'update']);
